...
import { getUserArchivedMeetings, unarchiveMeeting, apiFetch } from "../utils/api";

import "../styles/ArchivedMeetings.css";
import ConfirmModal from "./ConfirmModal";

function ArchivedMeetings({ user, onBack }) {
  ...
  const confirmDelete = async () => {
    ...
    try {
      await apiFetch(`/meetings/${confirmTarget.id}`, { method: "DELETE", credentials: "include" });
