// import { apiFetch } from "../utils/api"; // Removed unused import
    ...
    if (meetingDate > now) {
      ...
      return {
        ...
        icon: <FaClock />,
            ...
            let date; // Declare date variable
            if (typeof value === "object" && value.seconds) {
              date = new Date(value.seconds * 1000);
