...
function LandingPage() {
  ...
  // Exemplo de integração: buscar reuniões do back-end ao carregar a página
  React.useEffect(() => {
    async function fetchMeetings() {
      try {
        // Exemplo: buscar reuniões (ajuste o endpoint conforme sua API)
        const response = await import('../utils/api').then(m => m.apiFetch('/meetings'));
        console.log('Reuniões do back-end:', response);
      } catch (error) {
